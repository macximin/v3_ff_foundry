...
slots:
  ...
  - { b_id: B006, route_order: 600, status: hypothesis, target_anchor: A02, narrative_function: "가족 분업을 품삯과 책임이 있는 역할로 고정한다.", payoff_axis: "역할·몫", carried_reader_debt: "무급 가족 총동원 위험", contrast_requirement: "클로에 혼자 빨라지는 해법을 피한다." }
  - { b_id: B007, route_order: 700, status: hypothesis, target_anchor: A02, narrative_function: "반복 장부로 첫 실제 채무 감축을 만든다.", payoff_axis: "상환·신용", carried_reader_debt: "2,300금화 원금", contrast_requirement: "매출 자랑이 아니라 채무 상태가 바뀐다." }
  - { b_id: B008, route_order: 800, status: hypothesis, target_anchor: A03, narrative_function: "수도 수요를 에버하르트 농산물 판로와 연결한다.", payoff_axis: "영지 판로", carried_reader_debt: "몰락 영지의 현금흐름", contrast_requirement: "점포 안에서 생산지로 무대를 옮긴다." }
  - { b_id: B009, route_order: 900, status: hypothesis, target_anchor: A03, narrative_function: "첫 생산자의 품질과 생계를 함께 지키는 가격을 정한다.", payoff_axis: "공급자 신뢰", carried_reader_debt: "싼 재료만 찾을 위험", contrast_requirement: "구매자가 아니라 생산자가 평가한다." }
  - { b_id: B010, route_order: 1000, status: hypothesis, target_anchor: A03, narrative_function: "운송 손실을 보관·가공 기준으로 낮춘다.", payoff_axis: "수율·시간", carried_reader_debt: "수도-영지 거리", contrast_requirement: "맛보다 이동과 손실이 병목이다." }
